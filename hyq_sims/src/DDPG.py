...
class DDPG(object):
    def __init__(self, a_dim, s_dim, a_bound,MEMORY_CAPACITY,TAU,GAMMA,LR_C,LR_A):
    ...
    def learn(self,MEMORY_CAPACITY, BATCH_SIZE):
    ...
    def save(self,addr):
        ...
        saver.save(self.sess, './'+str(addr), write_meta_graph=False)

    def restore(self,addr):
        saver = tf.train.Saver()
        saver.restore(self.sess, './'+str(addr))
